...
const eventColor: Record<EdgeDef["kind"], string> = {
  ...
  verdict: "text-zinc-800 dark:text-zinc-200",
  ...
  return (
    <Panel
      ...
      action={
        <button
          onClick={onReset}
          className="inline-flex items-center gap-1 rounded px-1.5 py-0.5 font-mono text-[10px] text-zinc-500 hover:bg-zinc-100 hover:text-zinc-800 dark:hover:bg-zinc-900 dark:hover:text-zinc-300"
    ...
    >
      <div className="flex-1 overflow-y-auto">
        {transitions.length === 0 ? (
          <div className="px-3 py-6 text-center text-[11px] text-zinc-500 dark:text-zinc-600">
              ...
              return (
                <li key={i}>
                  <button
                    ...
                    className={cn(
                      "group flex w-full items-start gap-2 rounded-md border bg-white/60 px-2.5 py-2 text-left transition-colors dark:bg-zinc-950/60",
                      cannotFire
                        ? "cursor-not-allowed border-zinc-200 opacity-60 dark:border-zinc-900"
                        : "border-zinc-200 hover:border-amber-500/60 hover:bg-amber-500/5 dark:border-zinc-800",
                    )}
                  >
                    <ArrowRight
                      className={cn(
                        ...
                        cannotFire
                          ...
                          : "text-zinc-500 group-hover:text-amber-600 dark:group-hover:text-amber-400",
                      )}
                    />
      ...
      {!isCurrent && (
        <div className="border-t border-zinc-200/60 px-3 py-1.5 text-[10px] text-zinc-500 dark:border-zinc-900/80 dark:text-zinc-600">
          Click{" "}
          <span className="text-zinc-700 dark:text-zinc-400">
            {labelOfNode(currentId)}
          </span>{" "}
